...
export const GET = async (request: NextRequest): Promise<NextResponse> => {
  ...
  cookieStore.delete('payroll_oauth_state');
  cookieStore.delete('payroll_pkce_verifier');
  if (
    error !== null ||
    code === null ||
    state === null ||
    ...
    return NextResponse.redirect(new URL('/?auth_error=oauth_callback_invalid', request.url));
  }
  try {
