...
和响应硬上限；第三条覆盖首次开户入口、编排、密钥环、密文 Schema、平台凭据与
适配器注册边界。三组目标文件语句、分支、函数和行覆盖率均不得低于 90%。当前
组织投递 73 项、平台边界 88 项、首次开户 82 项测试全部通过；组织投递五个
生产文件合计为 98.27%/97.70%/96.55%/98.34%，平台边界五个生产文件合计为
97.18%/95.18%/100%/97.99%，首次开户七个生产文件合计为
99.08%/97.46%/100%/100%。真实平台沙箱回执、Secret 轮换、Prometheus 规则加载
