...
`pnpm --filter @gaoq/erp-api test:coverage`，323 个测试文件、2,788 项测试全部
通过；覆盖率为语句
87.72%（24,170/27,551）、分支 82.45%（16,023/19,433）、函数
89.82%（4,424/4,925）、行 89.47%（22,115/24,717）。全仓四维已达到 Phase 0
规定的 80% 门槛，分支高于最低值 476 个；必须保留专项 90% 门禁并继续增加
