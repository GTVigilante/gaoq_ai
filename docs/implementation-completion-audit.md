...
`pnpm --filter @gaoq/erp-api test:coverage`，322 个测试文件、2,345 项测试全部
通过；覆盖率为语句 84.17%（23,031/27,360）、分支 78.50%
（15,148/19,295）、函数 86.48%（4,235/4,897）、行 86.21%
（21,151/24,534）。分支仍需覆盖 288 个分支才能达到 Phase 0 规定的全系统 80% 门槛，必须作为实施缺口继续处理，禁止
