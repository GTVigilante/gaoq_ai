...
`pnpm --filter @gaoq/erp-api test:coverage`，322 个测试文件、2,278 项测试全部
通过；覆盖率为语句 83.87%、分支 77.60%、函数 86.31%、行 85.98%。分支仍需
覆盖 462 个分支才能达到 Phase 0 规定的全系统 80% 门槛，必须作为实施缺口继续处理，禁止
