...
`pnpm --filter @gaoq/erp-api test:coverage`，323 个测试文件、2,886 项测试全部
通过；覆盖率为语句
87.91%（24,236/27,567）、分支 82.85%（16,123/19,459）、函数
89.91%（4,430/4,927）、行 89.61%（22,165/24,733）。全仓四维已达到 Phase 0
规定的 80% 门槛，分支高于最低值 555 个；必须保留专项 90% 门禁并继续增加
