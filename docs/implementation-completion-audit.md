...
`pnpm --filter @gaoq/erp-api test:coverage`，323 个测试文件、2,730 项测试全部
通过；覆盖率为语句
87.02%（23,930/27,498）、分支 81.70%（15,829/19,373）、函数
89.05%（4,378/4,916）、行 88.74%（21,891/24,668）。全仓四维已达到 Phase 0
规定的 80% 门槛，分支高于最低值 330 个；必须保留专项 90% 门禁并继续增加
