...
`pnpm --filter @gaoq/erp-api test:coverage`，321 个测试文件、2,022 项测试全部
通过；覆盖率为语句 82.69%、分支 75.69%、函数 85.48%、行 84.97%。分支仍需
覆盖 831 个分支才能达到 Phase 0 规定的全系统 80% 门槛，必须作为实施缺口继续处理，禁止
