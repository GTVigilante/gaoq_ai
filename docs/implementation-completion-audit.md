...
`pnpm --filter @gaoq/erp-api test:coverage`，323 个测试文件、2,640 项测试全部
通过；覆盖率为语句
86.32%（23,718/27,476）、分支 80.97%（15,675/19,359）、函数
88.47%（4,347/4,913）、行 88.16%（21,728/24,645）。全仓四维已达到 Phase 0
