...
`pnpm --filter @gaoq/erp-api test:coverage`，323 个测试文件、2,784 项测试全部
通过；覆盖率为语句
87.34%（24,064/27,552）、分支 82.23%（15,985/19,439）、函数
89.29%（4,398/4,925）、行 89.06%（22,016/24,719）。全仓四维已达到 Phase 0
规定的 80% 门槛，分支高于最低值 433 个；必须保留专项 90% 门禁并继续增加
