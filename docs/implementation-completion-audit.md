...
`pnpm --filter @gaoq/erp-api test:coverage`，321 个测试文件、1,960 项测试全部
通过；覆盖率为语句 82.18%、分支 75.06%、函数 84.84%、行 84.50%。分支仍需
覆盖 951 个分支才能达到 Phase 0 规定的全系统 80% 门槛，必须作为实施缺口继续处理，禁止
