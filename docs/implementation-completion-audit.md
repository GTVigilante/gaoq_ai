...
`pnpm --filter @gaoq/erp-api test:coverage`，322 个测试文件、2,228 项测试全部
通过；覆盖率为语句 83.68%、分支 77.36%、函数 86.22%、行 85.82%。分支仍需
覆盖 509 个分支才能达到 Phase 0 规定的全系统 80% 门槛，必须作为实施缺口继续处理，禁止
