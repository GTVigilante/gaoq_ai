...
`pnpm --filter @gaoq/erp-api test:coverage`，323 个测试文件、2,748 项测试全部
通过；覆盖率为语句
87.19%（23,985/27,507）、分支 82.02%（15,907/19,394）、函数
89.20%（4,387/4,918）、行 88.92%（21,943/24,676）。全仓四维已达到 Phase 0
规定的 80% 门槛，分支高于最低值 391 个；必须保留专项 90% 门禁并继续增加
