...
`pnpm --filter @gaoq/erp-api test:coverage`，322 个测试文件、2,322 项测试全部
通过；覆盖率为语句 83.92%、分支 77.74%、函数 86.31%、行 86.01%。分支仍需
覆盖 436 个分支才能达到 Phase 0 规定的全系统 80% 门槛，必须作为实施缺口继续处理，禁止
