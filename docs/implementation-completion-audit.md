...
`pnpm --filter @gaoq/erp-api test:coverage`，323 个测试文件、2,677 项测试全部
通过；覆盖率为语句
86.76%（23,851/27,489）、分支 81.34%（15,753/19,365）、函数
89.01%（4,375/4,915）、行 88.58%（21,843/24,659）。全仓四维已达到 Phase 0
规定的 80% 门槛，分支高于最低值 261 个；必须保留专项 90% 门禁并继续增加
