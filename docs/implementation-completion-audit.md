...
`pnpm --filter @gaoq/erp-api test:coverage`，322 个测试文件、2,364 项测试全部
通过；覆盖率为语句 84.70%（23,177/27,363）、分支 79.13%
（15,277/19,304）、函数 86.86%（4,254/4,897）、行 86.66%
（21,264/24,537）。分支仍需覆盖 167 个分支才能达到 Phase 0 规定的全系统 80% 门槛，必须作为实施缺口继续处理，禁止
