...
`pnpm --filter @gaoq/erp-api test:coverage`，323 个测试文件、2,580 项测试全部
通过；覆盖率为语句
86.09%（23,637/27,456）、分支 80.58%（15,590/19,345）、函数
88.33%（4,339/4,912）、行 87.95%（21,658/24,625）。全仓四维已达到 Phase 0
