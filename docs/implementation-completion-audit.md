...
`pnpm --filter @gaoq/erp-api test:coverage`，322 个测试文件、2,184 项测试全部
通过；覆盖率为语句 83.47%、分支 77.06%、函数 86.14%、行 85.63%。分支仍需
覆盖 566 个分支才能达到 Phase 0 规定的全系统 80% 门槛，必须作为实施缺口继续处理，禁止
