...
`pnpm --filter @gaoq/erp-api test:coverage`，322 个测试文件、2,333 项测试全部
通过；覆盖率为语句 84.03%（22,991/27,360）、分支 78.13%
（15,074/19,293）、函数 86.35%（4,229/4,897）、行 86.10%
（21,125/24,534）。分支仍需覆盖 361 个分支才能达到 Phase 0 规定的全系统 80% 门槛，必须作为实施缺口继续处理，禁止
