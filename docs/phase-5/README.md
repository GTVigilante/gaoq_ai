...
7. [全量/增量迁移控制面契约](./09-data-migration-control-plane.md)（通用账本、组织参考数据、员工、劳动关系、审批模板、已终结历史、无文件活动审批、招聘 HC/职位、候选人隐私主档及面试前申请基线适配器已交付；面试/Offer/后续申请流水线、考勤、薪资、业务附件与三次演练待续）
