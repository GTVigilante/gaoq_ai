...
validateDeploymentWorkflow(apply, {
  ...
  requiredMarkers: [
    ...
    'PHASE6_DEPLOYMENT_AUTHORIZATION_SIGNER_KEYSET_SHA256: ${{ vars.PHASE6_DEPLOYMENT_AUTHORIZATION_SIGNER_KEYSET_SHA256 }}',
  ...
  forbiddenMarkers: [
    ...
    'diff --unified',
    '--write-plan-binding',
    'PHASE6_DEPLOYMENT_AUTHORIZATION_PUBLIC_KEY_PEM_BASE64',
    'PHASE6_DEPLOYMENT_AUTHORIZATION_PUBLIC_KEY_SHA256',
  ],
});
