...
const [dockerfile, compose, generator, imageSetter, mongoInit, publishWorkflow, exportWorkflow] = await Promise.all([
  readFile(new URL('../../docker/payroll.Dockerfile', import.meta.url), 'utf8'),
  readFile(new URL('../../deploy/payroll/standalone/compose.yaml', import.meta.url), 'utf8'),
  ...
  readFile(new URL('../../docker/payroll-mongo-init.js', import.meta.url), 'utf8'),
  readFile(new URL('../../.github/workflows/publish-payroll-images.yml', import.meta.url), 'utf8'),
  readFile(new URL('../../.github/workflows/export-payroll-images.yml', import.meta.url), 'utf8'),
]);
