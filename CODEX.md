...
- 2026-07-27 ERP API 全量覆盖率基线为语句 74.78%、分支 64.36%、函数
  76.97%、行 77.88%，尚未达到全仓 80% 强制门槛。租户上下文、身份授权、
  审批数据加密、审批仓储、MCP 确认、薪酬影子周期、Care 仓储和组织仓储已建立
  八项 90% 门禁，当前分别为
  ...
  （语句/分支/函数/行），并接入 `pnpm check`。审批应用服务已从
  76.98%/70.15%/82.88%/80.28% 提升至
  86.45%/72.61%/96.39%/89.78%，仍未达到 90%，后续轮次必须继续补齐全仓及
