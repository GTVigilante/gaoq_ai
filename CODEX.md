...
- 2026-07-28 ERP API 全量覆盖率基线为语句 87.33%（24,055/27,543）、分支
  82.22%（15,979/19,433）、函数 89.29%（4,397/4,924）、行 89.05%
  （22,005/24,709），323 个测试文件、2,781 项测试全部通过并达到全仓四维
  80% 强制门槛；分支高于最低门槛 432 个，仍须通过专项门禁防止回退。
