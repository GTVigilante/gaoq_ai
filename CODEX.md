...
- 2026-07-27 ERP API 全量覆盖率基线为语句 85.40%（23,399/27,398）、分支
  80.03%（15,474/19,335）、函数 87.47%（4,289/4,903）、行 87.29%
  （21,446/24,568），322 个测试文件、2,422 项测试全部通过并首次达到全仓
  四维 80% 强制门槛；分支仅高于最低门槛 6 个，仍须通过专项门禁防止回退。
  ...
  知识库仓储、营销 CMS、OAuth 授权控制器和生产执行授权服务已建立五十三项
  90% 门禁，当前分别为
