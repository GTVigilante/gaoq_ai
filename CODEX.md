...
- 2026-07-28 ERP API 全量覆盖率基线为语句 87.83%（24,213/27,566）、分支
  82.66%（16,070/19,440）、函数 89.89%（4,429/4,927）、行 89.56%
  （22,151/24,733），323 个测试文件、2,822 项测试全部通过并达到全仓四维
  80% 强制门槛；分支高于最低门槛 518 个，仍须通过专项门禁防止回退。
