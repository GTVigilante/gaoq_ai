...
- 2026-07-28 ERP API 全量覆盖率基线为语句 87.91%（24,236/27,567）、分支
  82.85%（16,123/19,459）、函数 89.91%（4,430/4,927）、行 89.61%
  （22,165/24,733），323 个测试文件、2,886 项测试全部通过并达到全仓四维
  80% 强制门槛；分支高于最低门槛 555 个，仍须通过专项门禁防止回退。
