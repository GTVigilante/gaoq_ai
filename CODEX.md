...
- 2026-07-27 ERP API 全量覆盖率基线为语句 75.87%、分支 66.22%、函数
  78.55%、行 78.82%，尚未达到全仓 80% 强制门槛。租户上下文、身份授权、
  审批数据加密、审批仓储、审批应用状态机、MCP 确认、薪酬影子周期、Care
  仓储、组织仓储、招聘仓储和知识库仓储已建立十一项 90% 门禁，当前分别为
