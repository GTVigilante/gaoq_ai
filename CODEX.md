...
- 2026-07-28 ERP API 覆盖率已修正为显式纳入 `src/**/*.ts` 全部生产源码，
  ...
  命令接入 `pnpm check`。当前真实基线为语句 85.01%（24,418/28,723）、
  分支 82.02%（16,223/19,779）、函数 86.06%（4,452/5,173）、行
  86.75%（22,326/25,736），327 个测试文件、3,029 项测试全部通过并达到
  全仓四维 80% 强制门槛；分支高于最低命中数 399 个。
