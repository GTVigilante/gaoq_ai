...
- 2026-07-28 ERP API 全量覆盖率基线为语句 85.82%（23,557/27,449）、分支
  80.50%（15,577/19,349）、函数 87.84%（4,314/4,911）、行 87.65%
  （21,578/24,618），323 个测试文件、2,516 项测试全部通过并达到全仓四维
  80% 强制门槛；分支高于最低门槛 97 个，仍须通过专项门禁防止回退。
  租户上下文、审计链锚定、审计链验证、组织主数据应用、身份授权、
