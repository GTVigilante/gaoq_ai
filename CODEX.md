...
- 2026-07-28 ERP API 全量覆盖率基线为语句 86.32%（23,718/27,476）、分支
  80.97%（15,675/19,359）、函数 88.47%（4,347/4,913）、行 88.16%
  （21,728/24,645），323 个测试文件、2,640 项测试全部通过并达到全仓四维
  80% 强制门槛；分支高于最低门槛 187 个，仍须通过专项门禁防止回退。
