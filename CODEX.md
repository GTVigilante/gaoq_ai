...
- 2026-07-28 ERP API 全量覆盖率基线为语句 87.02%（23,930/27,498）、分支
  81.70%（15,829/19,373）、函数 89.05%（4,378/4,916）、行 88.74%
  （21,891/24,668），323 个测试文件、2,730 项测试全部通过并达到全仓四维
  80% 强制门槛；分支高于最低门槛 330 个，仍须通过专项门禁防止回退。
