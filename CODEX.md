...
- 2026-07-28 ERP API 全量覆盖率基线为语句 87.19%（23,985/27,507）、分支
  82.02%（15,907/19,394）、函数 89.20%（4,387/4,918）、行 88.92%
  （21,943/24,676），323 个测试文件、2,748 项测试全部通过并达到全仓四维
  80% 强制门槛；分支高于最低门槛 391 个，仍须通过专项门禁防止回退。
