...
- 2026-07-28 ERP API 全量覆盖率基线为语句 86.01%（23,612/27,452）、分支
  80.58%（15,590/19,345）、函数 88.12%（4,328/4,911）、行 87.86%
  （21,633/24,621），323 个测试文件、2,546 项测试全部通过并达到全仓四维
  80% 强制门槛；分支高于最低门槛 114 个，仍须通过专项门禁防止回退。
