...
- 2026-07-27 ERP API 全量覆盖率基线为语句 84.70%（23,177/27,363）、分支
  79.13%（15,277/19,304）、函数 86.86%（4,254/4,897）、行 86.66%
  （21,264/24,537），分支尚需覆盖 167 个分支才能达到全仓四维 80% 强制门槛。租户上下文、审计链锚定、
  审计链验证、组织主数据应用、身份授权、
  ...
  知识库仓储、营销 CMS 和生产执行授权服务已建立五十二项 90% 门禁，当前分别为
