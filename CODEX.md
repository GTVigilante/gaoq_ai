...
- 2026-07-28 ERP API 全量覆盖率基线为语句 87.34%（24,064/27,552）、分支
  82.23%（15,985/19,439）、函数 89.29%（4,398/4,925）、行 89.06%
  （22,016/24,719），323 个测试文件、2,784 项测试全部通过并达到全仓四维
  80% 强制门槛；分支高于最低门槛 433 个，仍须通过专项门禁防止回退。
