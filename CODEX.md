...
- 2026-07-27 ERP API 全量覆盖率基线为语句 84.03%（22,991/27,360）、分支
  78.13%（15,074/19,293）、函数 86.35%（4,229/4,897）、行 86.10%
  （21,125/24,534），分支尚需覆盖 361 个分支才能达到全仓四维 80% 强制门槛。租户上下文、审计链锚定、
  审计链验证、组织主数据应用、身份授权、
  ...
  Knowledge 搜索索引 Relay、考勤应用、考勤仓储、考勤供应商拉取、考勤供应商入站处理、电子签回调处理、招聘渠道拉取、招聘渠道入站处理、招聘渠道职位扇出、招聘渠道阶段扇出、招聘申请、招聘面试、招聘渠道职位投递、招聘渠道阶段回传、招聘管理、人才全周期仓储、招聘 Offer、Care 仓储、组织仓储、招聘仓储、
  知识库仓储、营销 CMS 和生产执行授权服务已建立四十八项 90% 门禁，当前分别为
