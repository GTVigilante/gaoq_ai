...
- 2026-07-28 ERP API 全量覆盖率基线为语句 86.75%（23,840/27,480）、分支
  81.33%（15,745/19,359）、函数 89.01%（4,374/4,914）、行 88.57%
  （21,832/24,649），323 个测试文件、2,674 项测试全部通过并达到全仓四维
  80% 强制门槛；分支高于最低门槛 257 个，仍须通过专项门禁防止回退。
