...
- 2026-07-28 ERP API 全量覆盖率基线为语句 87.19%（23,976/27,498）、分支
  82.01%（15,901/19,388）、函数 89.20%（4,386/4,917）、行 88.91%
  （21,932/24,666），323 个测试文件、2,745 项测试全部通过并达到全仓四维
  80% 强制门槛；分支高于最低门槛 390 个，仍须通过专项门禁防止回退。
