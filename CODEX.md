...
- 2026-07-27 ERP API 全量覆盖率基线为语句 85.55%（23,478/27,441）、分支
  80.18%（15,510/19,343）、函数 87.61%（4,303/4,911）、行 87.41%
  （21,512/24,610），323 个测试文件、2,454 项测试全部通过并达到全仓四维
  80% 强制门槛；分支高于最低门槛 35 个，仍须通过专项门禁防止回退。
  ...
  知识库仓储、营销 CMS、OAuth 授权控制器、WebAuthn 强认证和生产执行授权服务
  已建立五十四项
  90% 门禁，当前分别为
