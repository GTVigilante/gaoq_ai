...
- 2026-07-28 ERP API 全量覆盖率基线为语句 87.73%（24,180/27,560）、分支
  82.46%（16,030/19,439）、函数 89.82%（4,425/4,926）、行 89.48%
  （22,126/24,727），323 个测试文件、2,791 项测试全部通过并达到全仓四维
  80% 强制门槛；分支高于最低门槛 478 个，仍须通过专项门禁防止回退。
