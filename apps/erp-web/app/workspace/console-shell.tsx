...
const NAVIGATION: NonNullable<MenuProps['items']> = [
  ...
  { key: '/workspace/recruitment', icon: <SolutionOutlined />, label: <Link href="/workspace/recruitment">招聘管理</Link> },
  { key: '/workspace/suppliers', icon: <ShopOutlined />, label: <Link href="/workspace/suppliers">供应方管理</Link> },
  { key: '/workspace/sourcing', icon: <FundProjectionScreenOutlined />, label: <Link href="/workspace/sourcing">服务寻源</Link> },
  { key: '/workspace/fulfillment', icon: <FileDoneOutlined />, label: <Link href="/workspace/fulfillment">履约与结算</Link> },
  { key: '/workspace/performance', icon: <RiseOutlined />, label: <Link href="/workspace/performance">绩效管理</Link> },
  { key: '/workspace/workforce', icon: <TeamOutlined />, label: <Link href="/workspace/workforce">HRBP 与汇报关系</Link> },
